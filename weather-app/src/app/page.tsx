...
export default function Home() {
  ...
  const [wrong, setError]=useState<boolean>(false);
  ...
  return (
    <>
      <div className=" root h-screen w-screen bg">
        {" "}
        <h1 className="text-4xl font-semibold text-center mt-4 ">Weather app</h1>
        ...
        {wrong ? (<p className="text-center font-medium text-slate-100 mt-4 text-2xl">You have misspelled the place name please try again</p>):(<><div className="w-full h-full flex-column justify-center  items-center  mt-4 drop-shadow-lg ">
  ...
  <p className="float-right">{getWeatherIcon(weather.current.icon_num)}</p>
) : null}
